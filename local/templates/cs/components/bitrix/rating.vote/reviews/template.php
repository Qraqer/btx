...
?><span class="ilike-light"><span
        ...
        <i class="fa fa-thumbs-up <?= ($arResult['USER_HAS_VOTED'] == 'N' ? '' : 'active') ?>" aria-hidden="true"></i><?= htmlspecialcharsEx($arResult['TOTAL_VOTES']) ?></span>

        <span
                class="bx-ilike-left-wrap" <?= ($arResult['VOTE_AVAILABLE'] == 'Y' ? '' : 'title="' . htmlspecialcharsbx($arResult['ALLOW_VOTE']['ERROR_MSG']) . '"') ?>><?
	        if ($arResult['VOTE_AVAILABLE'] == 'Y'):
		        ?><a href="#like"
                     class="bx-ilike-text"><?= ($arResult['USER_HAS_VOTED'] == 'N' ? htmlspecialcharsbx($arResult['RATING_TEXT_LIKE_Y']) : htmlspecialcharsbx($arResult['RATING_TEXT_LIKE_N'])) ?></a><?
	        endif; ?></span></span><span class="bx-ilike-wrap-block"
                                         id="bx-ilike-popup-cont-<?= htmlspecialcharsbx($arResult['VOTE_ID']) ?>"
                                         style="display:none;"><span class="bx-ilike-popup"><span
                    class="bx-ilike-wait"></span></span></span></span>
