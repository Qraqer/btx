        ...
        <div class="reviews-block-outer">
            <div class="reviews-block-inner">
				...
				foreach ($arResult["MESSAGES"] as $res):
					...
					$iCount++;
					?>
                    <div class="answer reviews-post-table <?= ($iCount == 1 ? "reviews-post-first " : "") ?><?
                                    ...
                                    <div class="reviews-post-reply-buttons">
                                        <noindex>
											...
											if ($arParams["SHOW_RATING"] == "Y") {
												...
												$GLOBALS["APPLICATION"]->IncludeComponent("bitrix:rating.vote", 'reviews', $arRatingParams, $component, array("HIDE_ICONS" => "Y"));
												?>
                                                </span><?
											}
											?>
