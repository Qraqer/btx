		...
		?> class="reviews-form">
            ...
            <div style="position:relative; display: block; width:100%;">
                ...
                <div class="reviews-reply-buttons">
                    <input class="btn" name="send_button" type="submit" value="<?= GetMessage("OPINIONS_SEND") ?>"
                           tabindex="<?= $tabIndex++; ?>" <?
					       ?>onclick="this.form.preview_comment.value = 'N';"/>
                    <input class="btn" name="view_button" type="submit" value="<?= GetMessage("OPINIONS_PREVIEW") ?>"
                           tabindex="<?= $tabIndex++; ?>" <?
