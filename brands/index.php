 ...
 */
define('NEED_EXTRA_MENU', 'brands');
require($_SERVER["DOCUMENT_ROOT"] . "/bitrix/header.php");
$APPLICATION->SetTitle("Каталог");

$request = \Bitrix\Main\Context::getCurrent()->getRequest();
$brandTypeFilter = $request->get('brandType');

global $catalogFilter;
if ($brandTypeFilter != 0) {
    $catalogFilter['PROPERTY_TYPE'] = $brandTypeFilter;
} ?>
    ...
    <div class="container">
        ...
        <? $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "LIST_PROPERTY_CODE" => \BH\Model\Brand::getComponentPropertiesSelect(),
                "MESSAGE_404" => "",
                "META_DESCRIPTION" => "-",
                "META_KEYWORDS" => "-",
                "NEWS_COUNT" => "10",
